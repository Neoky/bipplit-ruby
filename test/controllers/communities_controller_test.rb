...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post communities_url, params: { community: { body: @community.body, title: @community.title, url: @community.url, user_id: @community.user_id } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { body: @community.body, title: @community.title, url: @community.url, user_id: @community.user_id } }
